...
def test(args, model, tokenizer, test_dataset, best_threshold=0.5):
    ...
    f = open("../results/codet5/{}_{}_res.txt".format(args.project,args.fine_tune_factor), "a")
    for key in sorted(result.keys()):
...
def write_raw_preds_csv(args, y_preds):
    ...
    df.to_csv("../results/codet5/{}_{}_raw_preds.csv".format(args.project,args.fine_tune_factor), index=False)
